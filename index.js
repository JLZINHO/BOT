		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[鉂梋 ESTE PEDIDO 脡 ESPEC脥FICO PARA USUARIO MOD CAUSS BOT*',
					benned: 'Voc锚 para a banda, por favor, contate o propriet谩rio para abrir sua banda',
					ownerG: '[鉂梋 Causs? Este 茅 um recurso especial para o Causs 鉂�',
					ownerB: '[鉂梋 Causs? Este 茅 um recurso especial para o Causs 鉂�',
					userB: `鈹�鈹�銆� LISTA 銆嶁攢鈹�\nOl谩 Kak !\nDesculpe, irm茫. Voc锚 n茫o est谩 registrado como amigo de CAUSS. Registre-se para fazer amizade com o bot Causs por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Causs|17\n\n鈹�鈹�銆� CAUSS BOT 銆嶁攢鈹�`,
...
//@darkYT					
    ...
    break
				...
				case 'premiumlist':
					...
					teks += `鈹�+ Total : ${premium.length}\n鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *CAUSS BOT* 銆�*鈹�鈹�鈹�鈹�`
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`鈺攢鈹�鈹�鈹�*銆� *TOTAL DE USU脕RIOS CAUSS BOT 馃憫* 銆峔n\`\`\``
					no = 0
					for (let hehehe of user) {
						no += 1
						teks += `\`\`\`[${no.toString()}]\`\`\` @${hehehe.split('@')[0]}\n`
					}
					teks += `鈹�+ Total de usu谩rios : ${user.length}\n鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *CAUSS* 銆�*鈹�鈹�鈹�鈹�`
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Voc锚 n茫o 茅 um Membro Premium, entre em contato com o Causs ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *ADMINBOT CAUSS 鉁�* 銆峔n*鈹�+ wa.me/5547992091566*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *CAUSS* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER ADMIN DO BOT CAUSS_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *PREMIUM USER馃憫* 銆峔n*鈹�+ wa.me/554792091566/*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� * CAUSS* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER UM USU脕RIO PREMIUM DO CAUSS BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '锔�*canal do Causs:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
        ...
        case 'promover':
				...
				default:
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[ERROR]','red'), 'eita bixo comando n茫o registrado de', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
			console.log('Error : %s', color(e, 'red'))
